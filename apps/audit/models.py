...
class AuditAction(models.TextChoices):
    ...
    ADMIN_WORK_ORDER_CLOSE = "ADMIN_WORK_ORDER_CLOSE", "Admin work order close"
    ...
    TECHNICIAN_LEAVE_APPROVED = "TECHNICIAN_LEAVE_APPROVED", "Technician leave approved"
    TECHNICIAN_LEAVE_REJECTED = "TECHNICIAN_LEAVE_REJECTED", "Technician leave rejected"
    ...
    PACKAGE_UPDATED = "PACKAGE_UPDATED", "Package updated"
    PACKAGE_DELETED = "PACKAGE_DELETED", "Package deleted"
